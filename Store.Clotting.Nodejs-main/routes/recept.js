...
const thaiFontPath = 'D:\\ejs\\Store.Clotting.Nodejs-main\\public\\Fonts\\THSarabun.ttf'; // เปลี่ยนเส้นทางไปยังฟอนต์ที่ถูกต้อง
...
const filePath = path.join('D:\\ejs\\Store.Clotting.Nodejs-main\\public\\Recept', fileName);
